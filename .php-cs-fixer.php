...
$config->setRules([
    ...
    // Specifically, in `BkashObject.updateAttributes` we construct new
    // `BkashObject`s for metadata. We can't use `self` there because it
    // needs to be a raw `BkashObject`.
    'self_accessor' => false,
    ...
    // See https://github.com/bkash/bkash-php/pull/1230
