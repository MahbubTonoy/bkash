 ...
 * href="https://bkash.com/docs/api#financial_accounts">FinancialAccount's</a>
 * balance.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property int $amount Amount (in cents) transferred.
 * @property \Bkash\BkashObject $balance_impact Change to a FinancialAccount's balance
 ...
 * @property null|\Bkash\Collection<\Bkash\Treasury\TransactionEntry> $entries A list of TransactionEntries that are part of this Transaction. This cannot be expanded in any list endpoints.
 ...
 * @property null|\Bkash\BkashObject $flow_details Details of the flow that created the Transaction.
