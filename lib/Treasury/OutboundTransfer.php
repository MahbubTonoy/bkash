 ...
 * href="https://bkash.com/docs/api#financial_accounts">FinancialAccount</a> to a
 * PaymentMethod belonging to the same entity. To send funds to a different party,
 * use <a href="https://bkash.com/docs/api#outbound_payments">OutboundPayments</a>
 ...
 * @property \Bkash\BkashObject $destination_payment_method_details
 ...
 * @property null|\Bkash\BkashObject $returned_details Details about a returned OutboundTransfer. Only set when the status is <code>returned</code>.
 ...
 */
class OutboundTransfer extends \Bkash\ApiResource
{
     ...
     *
     * @return \Bkash\Treasury\OutboundTransfer the canceled outbound transfer
     */
