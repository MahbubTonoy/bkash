...
/**
 * Use <a
 * href="https://bkash.com/docs/treasury/moving-money/financial-accounts/into/inbound-transfers">InboundTransfers</a>
 * to add funds to your <a
 * href="https://bkash.com/docs/api#financial_accounts">FinancialAccount</a> via a
 ...
 * @property null|\Bkash\BkashObject $failure_details Details about this InboundTransfer's failure. Only set when status is <code>failed</code>.
 ...
 * @property \Bkash\BkashObject $linked_flows
 ...
 * @property null|\Bkash\BkashObject $origin_payment_method_details Details about the PaymentMethod for an InboundTransfer.
 ...
 * @property null|string|\Bkash\Treasury\Transaction $transaction The Transaction associated with this object.
 */
class InboundTransfer extends \Bkash\ApiResource
{
     ...
     *
     * @return \Bkash\Treasury\InboundTransfer the canceled inbound transfer
     */
