...
/**
 * Bkash Treasury provides users with a container for money called a
 ...
 * @property \Bkash\BkashObject $balance Balance information for the FinancialAccount
 ...
 * @property \Bkash\Treasury\FinancialAccountFeatures $features Encodes whether a FinancialAccount has access to a particular Feature, with a <code>status</code> enum and associated <code>status_details</code>. Bkash or the platform can control Features via the requested field.
 * @property \Bkash\BkashObject[] $financial_addresses The set of credentials that resolve to a FinancialAccount.
 ...
 * @property null|\Bkash\BkashObject $platform_restrictions The set of functionalities that the platform can restrict on the FinancialAccount.
 ...
 * @property \Bkash\BkashObject $status_details
 ...
 */
class FinancialAccount extends \Bkash\ApiResource
{
     ...
     *
     * @return \Bkash\Treasury\FinancialAccount the retrieved financial account
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Treasury\FinancialAccount the updated financial account
     */
