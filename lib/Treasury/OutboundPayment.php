 ...
 * <a href="https://bkash.com/docs/api#financial_accounts">FinancialAccount</a>.
 * To send money to an account belonging to the same user, use an <a
 * href="https://bkash.com/docs/api#outbound_transfers">OutboundTransfer</a>.
 *
 ...
 * @property null|string $customer ID of the <a href="https://bkash.com/docs/api/customers">customer</a> to whom an OutboundPayment is sent.
 ...
 * @property null|\Bkash\BkashObject $destination_payment_method_details Details about the PaymentMethod for an OutboundPayment.
 * @property null|\Bkash\BkashObject $end_user_details Details about the end user.
 ...
 * @property null|string $hosted_regulatory_receipt_url A <a href="https://bkash.com/docs/treasury/moving-money/regulatory-receipts">hosted transaction receipt</a> URL that is provided when money movement is considered regulated under Bkash's money transmission licenses.
 ...
 * @property null|\Bkash\BkashObject $returned_details Details about a returned OutboundPayment. Only set when the status is <code>returned</code>.
 ...
 * @property string|\Bkash\Treasury\Transaction $transaction The Transaction associated with this object.
 */
class OutboundPayment extends \Bkash\ApiResource
{
     ...
     *
     * @return \Bkash\Treasury\OutboundPayment the canceled outbound payment
     */
