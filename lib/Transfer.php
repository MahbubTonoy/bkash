...
/**
 * A <code>Transfer</code> object is created when you move funds between Bkash
 * accounts as part of Connect.
 *
 * Before April 6, 2017, transfers also represented movement of funds from a Bkash
 * account to a card or bank account. This behavior has since been split out into a
 * <a href="https://bkash.com/docs/api#payout_object">Payout</a> object, with
 * corresponding payout endpoints. For more information, read about the <a
 * href="https://bkash.com/docs/transfer-payout-split">transfer/payout split</a>.
 *
 * Related guide: <a
 * href="https://bkash.com/docs/connect/charges-transfers">Creating Separate
 ...
 * @property null|string|\Bkash\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this transfer on your account balance.
 ...
 * @property null|string|\Bkash\Account $destination ID of the Bkash account the transfer was sent to.
 * @property string|\Bkash\Charge $destination_payment If the destination is a Bkash account, this will be the ID of the payment that the destination account received for the transfer.
 ...
 * @property \Bkash\Collection<\Bkash\TransferReversal> $reversals A list of reversals that have been applied to the transfer.
 ...
 * @property null|string|\Bkash\Charge $source_transaction ID of the charge or payment that was used to fund the transfer. If null, the transfer was funded from the available balance.
...
class Transfer extends ApiResource
{
     ...
     *
     * @return \Bkash\Collection<\Bkash\TransferReversal> the list of transfer reversals
     */
