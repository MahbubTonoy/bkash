 ...
 * conjunction with <a href="https://bkash.com/docs/api#prices">Prices</a> to
 ...
 * a subscription</a>, <a
 * href="https://bkash.com/docs/payments/payment-links/overview">share a Payment
 * Link</a>, <a
 * href="https://bkash.com/docs/payments/accept-a-payment#create-product-prices-upfront">accept
 ...
 * @property null|string|\Bkash\Price $default_price The ID of the <a href="https://bkash.com/docs/api/prices">Price</a> object that is the default price for this product.
 ...
 * @property null|\Bkash\BkashObject $package_dimensions The dimensions of this product for shipping purposes.
 ...
 * @property null|string|\Bkash\TaxCode $tax_code A <a href="https://bkash.com/docs/tax/tax-categories">tax code</a> ID.
 ...
 * @property null|string $unit_label A label that represents units of this product in Bkash and on customers’ receipts and invoices. When set, this will be included in associated invoice line item descriptions.
...
class Product extends ApiResource
{
     ...
     *
     * @return \Bkash\SearchResult<Product> the product search results
     */
