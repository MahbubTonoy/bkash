 ...
 *
 * Related guide: <a
 * href="https://bkash.com/docs/billing/invoices/credit-notes">Credit Notes</a>.
 *
 ...
 * @property string|\Bkash\Customer $customer ID of the customer.
 * @property null|string|\Bkash\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 * @property int $discount_amount The integer amount in %s representing the total amount of discount that was credited.
 * @property \Bkash\BkashObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 * @property string|\Bkash\Invoice $invoice ID of the invoice.
 * @property \Bkash\Collection<\Bkash\CreditNoteLineItem> $lines Line items that make up the credit note
 ...
 * @property null|int $out_of_band_amount Amount that was credited outside of Bkash.
 ...
 * @property null|string|\Bkash\Refund $refund Refund related to this credit note.
 * @property string $status Status of this credit note, one of <code>issued</code> or <code>void</code>. Learn more about <a href="https://bkash.com/docs/billing/invoices/credit-notes#voiding">voiding credit notes</a>.
 ...
 * @property \Bkash\BkashObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \Bkash\CreditNote the previewed credit note
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\CreditNoteLineItem> list of CreditNoteLineItems
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\CreditNote the voided credit note
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\CreditNoteLineItem> the list of credit note line items
     */
