...
class Bkash
{
    /** @var string The Bkash API key to be used for requests. */
    public static $apiKey;

    /** @var string The Bkash client_id to be used for Connect requests. */
    public static $clientId;

    /** @var string The base URL for the Bkash API. */
    public static $apiBase = 'https://api.bkash.com';

    /** @var string The base URL for the OAuth API. */
    public static $connectBase = 'https://connect.bkash.com';

    /** @var string The base URL for the Bkash API uploads endpoint. */
    public static $apiUploadBase = 'https://files.bkash.com';

    /** @var null|string The version of the Bkash API to use for requests. */
    ...
    /** @var float Maximum delay between retries, in seconds, that will be respected from the Bkash API */
    ...
    /**
     * @return null|string The Bkash account ID for connected account
     *   requests
     */
    ...
    /**
     * @param string $accountId the Bkash account ID to set for connected
     *   account requests
     */
    ...
    /**
     * @return float Maximum delay between retries, in seconds, that will be respected from the Bkash API
     */
     ...
     *
     * Client telemetry enables timing and request metrics to be sent back to Bkash as an HTTP Header
     * with the current request. This enables Bkash to do latency and metrics analysis without adding extra
