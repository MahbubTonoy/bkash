...
/**
 * <code>Exchange Rate</code> objects allow you to determine the rates that Bkash
 ...
 * Please refer to our <a href="https://bkash.com/docs/exchange-rates">Exchange
 ...
 * @property \Bkash\BkashObject $rates Hash where the keys are supported currencies and the values are the exchange rate at which the base id currency converts to the key currency.
 */
