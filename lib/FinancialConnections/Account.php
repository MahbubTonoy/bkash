 ...
 * Bkash, to which you have been granted some degree of access.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|\Bkash\BkashObject $account_holder The account holder that this account belongs to.
 * @property null|\Bkash\BkashObject $balance The most recent information about the account's balance.
 * @property null|\Bkash\BkashObject $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|string|\Bkash\FinancialConnections\AccountOwnership $ownership The most recent information about the account's owners.
 * @property null|\Bkash\BkashObject $ownership_refresh The state of the most recent attempt to refresh the account owners.
 ...
 * @property string[] $supported_payment_method_types The <a href="https://bkash.com/docs/api/payment_methods/object#payment_method_object-type">PaymentMethod type</a>(s) that can be created from this account.
 */
class Account extends \Bkash\ApiResource
{
     ...
     *
     * @return \Bkash\FinancialConnections\Account the disconnected account
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\FinancialConnections\AccountOwner> list of BankConnectionsResourceOwners
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\FinancialConnections\Account the refreshed account
     */
