 ...
 * They represent a customer's payment instrument, and can be used with the Bkash
 * API just like a <code>Card</code> object: once chargeable, they can be charged,
 * or can be attached to customers.
 *
 * Bkash doesn't recommend using the deprecated <a
 * href="https://bkash.com/docs/api/sources">Sources API</a>. We recommend that
 * you adopt the <a
 * href="https://bkash.com/docs/api/payment_methods">PaymentMethods API</a>. This
 * newer API provides access to our latest features and payment method types.
 *
 * Related guides: <a href="https://bkash.com/docs/sources">Sources API</a> and <a
 * href="https://bkash.com/docs/sources/customers">Sources &amp; Customers</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property \Bkash\BkashObject $ach_credit_transfer
 * @property \Bkash\BkashObject $ach_debit
 ...
 * @property \Bkash\BkashObject $code_verification
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency Three-letter <a href="https://bkash.com/docs/currencies">ISO code for the currency</a> associated with the source. This is the currency for which the source will be chargeable once ready. Required for <code>single_use</code> sources.
 ...
 * @property \Bkash\BkashObject $multibanco
 * @property null|\Bkash\BkashObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property \Bkash\BkashObject $p24
 * @property \Bkash\BkashObject $receiver
 * @property \Bkash\BkashObject $redirect
 * @property \Bkash\BkashObject $sepa_credit_transfer
 * @property \Bkash\BkashObject $sepa_debit
 * @property \Bkash\BkashObject $sofort
 * @property \Bkash\BkashObject $source_order
 ...
 * @property \Bkash\BkashObject $wechat
 */
class Source extends ApiResource
{
     ...
     *
     * @throws \Bkash\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Source the detached source
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\SourceTransaction> list of SourceTransactions
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Source the verified source
     */
