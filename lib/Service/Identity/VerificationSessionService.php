...
class VerificationSessionService extends \Bkash\Service\AbstractService
{
    /**
     ...
     *
     * @return \Bkash\Collection<\Bkash\Identity\VerificationSession>
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Identity\VerificationSession
     */
    ...
    /**
     * Redact a VerificationSession to remove all collected information from Bkash.
     ...
     *
     * Redaction is irreversible. Redacted objects are still accessible in the Bkash
