...
class TaxCodeService extends \Bkash\Service\AbstractService
{
    /**
     * A list of <a href="https://bkash.com/docs/tax/tax-categories">all tax codes
     ...
     *
     * @return \Bkash\Collection<\Bkash\TaxCode>
     */
     ...
     * Bkash will return the corresponding tax code information.
     *
     * @param string $id
     * @param null|array $params
     * @param null|array|\Bkash\Util\RequestOptions $opts
