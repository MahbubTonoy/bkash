...
class SkuService extends \Bkash\Service\AbstractService
{
    /**
     ...
     *
     * @return \Bkash\Collection<\Bkash\SKU>
     */
     ...
     * either a SKU creation request or from the product, and Bkash will return the
