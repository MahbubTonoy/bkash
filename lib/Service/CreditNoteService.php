...
class CreditNoteService extends \Bkash\Service\AbstractService
{
    /**
     ...
     *
     * @return \Bkash\Collection<\Bkash\CreditNote>
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\CreditNoteLineItem>
     */
     ...
     * <li>Outside of Bkash credit: record the amount that is or will be credited
     * outside of Bkash (using <code>out_of_band_amount</code>).</li> </ul>
     *
     * For post-payment credit notes the sum of the refund, credit and outside of
     * Bkash amounts must equal the credit note total.
     *
