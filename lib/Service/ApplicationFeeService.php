...
class ApplicationFeeService extends \Bkash\Service\AbstractService
{
    /**
     ...
     *
     * @return \Bkash\Collection<\Bkash\ApplicationFee>
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\ApplicationFeeRefund>
     */
     ...
     * refunded. Funds will be refunded to the Bkash account from which the fee was
