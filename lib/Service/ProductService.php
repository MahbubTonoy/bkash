...
class ProductService extends \Bkash\Service\AbstractService
{
    /**
     ...
     *
     * @return \Bkash\Collection<\Bkash\Product>
     */
     ...
     * either a product creation request or the product list, and Bkash will return
    ...
    /**
     * Search for products you’ve previously created using Bkash’s <a
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\SearchResult<\Bkash\Product>
     */
