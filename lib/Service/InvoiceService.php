...
class InvoiceService extends \Bkash\Service\AbstractService
{
    /**
     ...
     *
     * @return \Bkash\Collection<\Bkash\Invoice>
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\InvoiceLineItem>
     */
    ...
    /**
     * Bkash automatically finalizes drafts before sending and attempting payment on
    ...
    /**
     * Bkash automatically creates and then attempts to collect payment on invoices
     * for customers on subscriptions according to your <a
     * href="https://dashboard.bkash.com/account/billing/automatic">subscriptions
    ...
    /**
     * Search for invoices you’ve previously created using Bkash’s <a
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\SearchResult<\Bkash\Invoice>
     */
    ...
    /**
     * Bkash will automatically send invoices to customers according to your <a
     * href="https://dashboard.bkash.com/account/billing/automatic">subscriptions
     ...
     *
     * If you would like to stop the Bkash Billing engine from automatically
