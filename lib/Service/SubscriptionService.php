...
class SubscriptionService extends \Bkash\Service\AbstractService
{
    /**
     ...
     *
     * @return \Bkash\Collection<\Bkash\Subscription>
     */
     ...
     *
     * By default, upon subscription cancellation, Bkash will stop automatic
    ...
    /**
     * Search for subscriptions you’ve previously created using Bkash’s <a
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\SearchResult<\Bkash\Subscription>
     */
