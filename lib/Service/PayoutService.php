...
class PayoutService extends \Bkash\Service\AbstractService
{
    /**
     * Returns a list of existing payouts sent to third-party bank accounts or that
     * Bkash has sent you. The payouts are returned in sorted order, with the most
     ...
     *
     * @return \Bkash\Collection<\Bkash\Payout>
     */
     ...
     * href="#balance">Bkash balance</a> must be able to cover the payout amount, or
     ...
     *
     * If you are creating a manual payout on a Bkash account that uses multiple
     ...
     * either a payout creation request or the payout list, and Bkash will return the
