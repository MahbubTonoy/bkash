...
class PaymentMethodService extends \Bkash\Service\AbstractService
{
    /**
     * Returns a list of PaymentMethods attached to the BkashAccount. For listing a
     ...
     * href="/docs/bkash-js/reference#bkash-create-payment-method">Bkash.js
     * reference</a> to learn how to create PaymentMethods via Bkash.js.
     *
    ...
    /**
     * Retrieves a PaymentMethod object attached to the BkashAccount. To retrieve a
