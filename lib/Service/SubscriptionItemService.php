...
class SubscriptionItemService extends \Bkash\Service\AbstractService
{
    /**
     ...
     *
     * @return \Bkash\Collection<\Bkash\SubscriptionItem>
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\UsageRecordSummary>
     */
     ...
     * with a quantity.
     *
     * Usage records provide <code>quantity</code> information that Bkash uses to
     * track how much a customer is using your service. With usage information and the
     * pricing model set up by the <a
     * href="https://bkash.com/docs/billing/subscriptions/metered-billing">metered
     * billing</a> plan, Bkash helps you send accurate invoices to your customers.
     *
     ...
     * there is more than one usage record with the same timestamp, Bkash adds the
     ...
     * href="https://bkash.com/docs/billing/subscriptions/tiers">tiered pricing</a>
     * model.
     *
     * @param string $parentId
     * @param null|array $params
