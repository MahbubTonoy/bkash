...
class CustomerService extends \Bkash\Service\AbstractService
{
    /**
     ...
     *
     * @return \Bkash\Collection<\Bkash\Customer>
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\CustomerBalanceTransaction>
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\CustomerCashBalanceTransaction>
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\PaymentMethod>
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\BankAccount|\Bkash\Card|\Bkash\Source>
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\TaxId>
     */
    ...
    /**
     * Search for customers you’ve previously created using Bkash’s <a
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\SearchResult<\Bkash\Customer>
     */
