...
class OrderService extends \Bkash\Service\AbstractService
{
    /**
     ...
     *
     * @return \Bkash\Collection<\Bkash\Order>
     */
     ...
     * either an order creation request or the order list, and Bkash will return the
