...
class TransferService extends \Bkash\Service\AbstractService
{
    /**
     ...
     *
     * @return \Bkash\Collection<\Bkash\Transfer>
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\TransferReversal>
     */
    ...
    /**
     * To send funds from your Bkash account to a connected account, you create a new
     * transfer object. Your <a href="#balance">Bkash balance</a> must be able to
     ...
     * from either a transfer creation request or the transfer list, and Bkash will
