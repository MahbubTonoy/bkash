...
namespace Bkash\Sigma;

/**
 * If you have <a href="https://bkash.com/docs/sigma/scheduled-queries">scheduled
 ...
 * @property int $data_load_time When the query was run, Sigma contained a snapshot of your Bkash data at this time.
 * @property \Bkash\BkashObject $error
 * @property null|\Bkash\File $file The file object representing the results of the query.
 ...
 */
class ScheduledQueryRun extends \Bkash\ApiResource
{
