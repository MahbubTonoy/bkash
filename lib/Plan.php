 ...
 * href="https://bkash.com/docs/api#prices">Prices API</a>. It replaces the Plans
 ...
 * of products. <a href="https://bkash.com/docs/api#products">Products</a> help
 ...
 * @property null|string|\Bkash\Product $product The product whose pricing this plan determines.
 ...
 * @property null|\Bkash\BkashObject $transform_usage Apply a transformation to the reported usage or set quantity before computing the amount billed. Cannot be combined with <code>tiers</code>.
 * @property null|int $trial_period_days Default number of trial days when subscribing a customer to this plan using <a href="https://bkash.com/docs/api#create_subscription-trial_from_plan"><code>trial_from_plan=true</code></a>.
