...
namespace Bkash\Reporting;

/**
 * The Report Run object represents an instance of a report type generated with
 * specific run parameters. Once the object is created, Bkash begins processing
 ...
 * href="https://bkash.com/docs/reporting/statements/api">API Access to
 * Reports</a>.
 *
 ...
 * @property \Bkash\BkashObject $parameters
 * @property string $report_type The ID of the <a href="https://bkash.com/docs/reports/report-types">report type</a> to run, such as <code>&quot;balance.summary.1&quot;</code>.
 * @property null|\Bkash\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
 ...
 */
class ReportRun extends \Bkash\ApiResource
{
