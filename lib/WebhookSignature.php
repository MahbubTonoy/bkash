...
abstract class WebhookSignature
{
    ...
    /**
     * Verifies the signature header sent by Bkash. Throws an
     * Exception\SignatureVerificationException exception if the verification fails for
     * any reason.
     *
     * @param string $payload the payload sent by Bkash
     ...
     *
     * The current scheme used by Bkash ("v1") is HMAC/SHA-256.
     *
