...
/**
 * This is an object representing a person associated with a Bkash account.
 *
 ...
 * account. See the <a
 * href="https://bkash.com/docs/connect/standard-accounts">Standard onboarding</a>
 * or <a href="https://bkash.com/docs/connect/express-accounts">Express onboarding
 * documentation</a> for information about platform pre-filling and account
 * onboarding steps.
 *
 * Related guide: <a
 * href="https://bkash.com/docs/connect/identity-verification-api#person-information">Handling
 ...
 * @property null|\Bkash\BkashObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\Bkash\BkashObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \Bkash\BkashObject $dob
 ...
 * @property null|\Bkash\BkashObject $future_requirements Information about the upcoming new requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \Bkash\BkashObject $registered_address
 * @property \Bkash\BkashObject $relationship
 * @property null|\Bkash\BkashObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \Bkash\BkashObject $verification
 */
class Person extends ApiResource
{
    ...
    /**
     * @return string the API URL for this Bkash account reversal
     */
     ...
     *
     * @throws \Bkash\Exception\BadMethodCallException
     */
