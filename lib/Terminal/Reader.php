 ...
 *
 * Related guide: <a
 * href="https://bkash.com/docs/terminal/payments/connect-reader">Connecting to a
 * Reader</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|\Bkash\BkashObject $action The most recent action performed by the reader.
 * @property null|string $device_sw_version The current software version of the reader.
 * @property string $device_type Type of reader, one of <code>bbpos_wisepad3</code>, <code>bkash_m2</code>, <code>bbpos_chipper2x</code>, <code>bbpos_wisepos_e</code>, <code>verifone_P400</code>, or <code>simulated_wisepos_e</code>.
 ...
 * @property null|string|\Bkash\Terminal\Location $location The location identifier of the reader.
 ...
 */
class Reader extends \Bkash\ApiResource
{
     ...
     *
     * @return \Bkash\Terminal\Reader the canceled reader
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Terminal\Reader the processed reader
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Terminal\Reader the seted reader
     */
