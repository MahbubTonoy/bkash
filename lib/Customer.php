 ...
 *
 * Related guide: <a
 * href="https://bkash.com/docs/payments/save-during-payment">Save a card during
 * payment</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|\Bkash\BkashObject $address The customer's address.
 * @property int $balance Current balance, if any, being stored on the customer. If negative, the customer has credit to apply to their next invoice. If positive, the customer has an amount owed that will be added to their next invoice. The balance does not refer to any unpaid invoices; it solely takes into account amounts that have yet to be successfully applied to any invoice. This balance is only taken into account as invoices are finalized.
 * @property null|\Bkash\CashBalance $cash_balance The current funds being held by Bkash on behalf of the customer. These funds can be applied towards payment intents with source &quot;cash_balance&quot;. The settings[reconciliation_mode] field describes whether these funds are applied to such payment intents manually or automatically.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency Three-letter <a href="https://bkash.com/docs/currencies">ISO code for the currency</a> the customer can be charged in for recurring billing purposes.
 * @property null|string|\Bkash\Account|\Bkash\BankAccount|\Bkash\Card|\Bkash\Source $default_source <p>ID of the default payment source for the customer.</p><p>If you are using payment methods created via the PaymentMethods API, see the <a href="https://bkash.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method">invoice_settings.default_payment_method</a> field instead.</p>
 * @property null|bool $delinquent <p>When the customer's latest invoice is billed by charging automatically, <code>delinquent</code> is <code>true</code> if the invoice's latest charge failed. When the customer's latest invoice is billed by sending an invoice, <code>delinquent</code> is <code>true</code> if the invoice isn't paid by its due date.</p><p>If an invoice is marked uncollectible by <a href="https://bkash.com/docs/billing/automatic-collection">dunning</a>, <code>delinquent</code> doesn't get reset to <code>false</code>.</p>
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property null|\Bkash\Discount $discount Describes the current discount active on the customer, if there is one.
 * @property null|string $email The customer's email address.
 * @property \Bkash\BkashObject $invoice_credit_balance The current multi-currency balances, if any, being stored on the customer. If positive in a currency, the customer has a credit to apply to their next invoice denominated in that currency. If negative, the customer has an amount owed that will be added to their next invoice denominated in that currency. These balances do not refer to any unpaid invoices. They solely track amounts that have yet to be successfully applied to any invoice. A balance in a particular currency is only applied to any invoice as an invoice in that currency is finalized.
 * @property null|string $invoice_prefix The prefix for the customer used to generate unique invoice numbers.
 * @property \Bkash\BkashObject $invoice_settings
 ...
 * @property null|\Bkash\BkashObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property \Bkash\Collection<\Bkash\Account|\Bkash\BankAccount|\Bkash\Card|\Bkash\Source> $sources The customer's payment sources, if any.
 * @property \Bkash\Collection<\Bkash\Subscription> $subscriptions The customer's current subscriptions, if any.
 * @property \Bkash\BkashObject $tax
 ...
 * @property \Bkash\Collection<\Bkash\TaxId> $tax_ids The customer's tax IDs.
 * @property null|string|\Bkash\TestHelpers\TestClock $test_clock ID of the test clock this customer belongs to.
 */
class Customer extends ApiResource
{
     ...
     *
     * @return \Bkash\Customer the updated customer
     */
     ...
     *
     * @return \Bkash\Collection<\Bkash\PaymentMethod> list of PaymentMethods
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Customer the retrieved customer
     */
    public function retrievePaymentMethod($payment_method, $params = null, $opts = null)
    {
        ...
        $obj = \Bkash\Util\Util::convertToBkashObject($response, $opts);
        $obj->setLastResponse($response);
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\SearchResult<Customer> the customer search results
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\CustomerBalanceTransaction> the list of customer balance transactions
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\CustomerBalanceTransaction
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\CustomerCashBalanceTransaction> the list of customer cash balance transactions
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\CustomerCashBalanceTransaction
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\BankAccount|\Bkash\Card|\Bkash\Source> the list of payment sources (BankAccount, Card or Source)
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\BankAccount|\Bkash\Card|\Bkash\Source
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\TaxId> the list of tax ids
     */
