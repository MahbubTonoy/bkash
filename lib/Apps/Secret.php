...
namespace Bkash\Apps;

/**
 * Secret Store is an API that allows Bkash Apps developers to securely persist
 ...
 *
 * Related guide: <a
 * href="https://bkash.com/docs/bkash-apps/store-auth-data-custom-objects">Store
 ...
 * @property \Bkash\BkashObject $scope
 */
class Secret extends \Bkash\ApiResource
{
     ...
     *
     * @return \Bkash\Apps\Secret the deleted secret
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Apps\Secret the finded secret
     */
