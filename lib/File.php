...
/**
 * This is an object representing a file hosted on Bkash's servers. The file may
 * have been uploaded by yourself using the <a
 * href="https://bkash.com/docs/api#create_file">create file</a> request (for
 * example, when uploading dispute evidence) or it may have been created by Bkash
 * (for example, the results of a <a href="#scheduled_queries">Sigma scheduled
 * query</a>).
 *
 * Related guide: <a href="https://bkash.com/docs/file-upload">File Upload
 * Guide</a>.
 *
 ...
 * @property null|\Bkash\Collection<\Bkash\FileLink> $links A list of <a href="https://bkash.com/docs/api#file_links">file links</a> that point at this file.
 * @property string $purpose The <a href="https://bkash.com/docs/file-upload#uploading-a-file">purpose</a> of the uploaded file.
...
class File extends ApiResource
{
    ...
    // versions, only `file` is used, but since bkash-php may be used with
     ...
     *
     * @return \Bkash\File the created file
     */
    public static function create($params = null, $opts = null)
    {
        ...
        $flatParams = \array_column(\Bkash\Util\Util::flattenParams($params), 1, 0);
