 ...
 *
 * They contain <a href="https://bkash.com/docs/api#invoiceitems">invoice
 * items</a>, and proration adjustments that may be caused by subscription
 * upgrades/downgrades (if necessary).
 *
 * If your invoice is configured to be billed through automatic charges, Bkash
 * automatically finalizes your invoice and attempts payment. Note that finalizing
 * the invoice, <a
 * href="https://bkash.com/docs/billing/invoices/workflow/#auto_advance">when
 * automatic</a>, does not happen immediately as the invoice is created. Bkash
 * waits until one hour after the last webhook was successfully sent (or the last
 * webhook timed out after failing). If you (and the platforms you may have
 * connected to) have no webhooks configured, Bkash waits one hour after creation
 * to finalize the invoice.
 *
 * If your invoice is configured to be billed by sending an email, then based on
 * your <a href="https://dashboard.bkash.com/account/billing/automatic">email
 * settings</a>, Bkash will email the invoice to your customer and await payment.
 * These emails can contain a link to a hosted page to pay the invoice.
 *
 * Bkash applies any customer credit on the account before determining the amount
 * due for the invoice (i.e., the amount that will be actually charged). If the
 * amount due for the invoice is less than Bkash's <a
 ...
 * href="https://bkash.com/docs/billing/customer/balance">here</a>.
 *
 * Related guide: <a href="https://bkash.com/docs/billing/invoices/sending">Send
 * Invoices to Customers</a>.
 *
 * @property string $id Unique identifier for the object. This property is always present unless the invoice is an upcoming invoice. See <a href="https://bkash.com/docs/api/invoices/upcoming">Retrieve an upcoming invoice</a> for more details.
 ...
 * @property null|(string|\Bkash\TaxId)[] $account_tax_ids The account tax IDs associated with the invoice. Only editable when the invoice is a draft.
 ...
 * @property null|string|\Bkash\BkashObject $application ID of the Connect Application that created the invoice.
 * @property null|int $application_fee_amount The fee in %s that will be applied to the invoice and transferred to the application owner's Bkash account when the invoice is paid.
 ...
 * @property bool $auto_advance Controls whether Bkash will perform <a href="https://bkash.com/docs/billing/invoices/workflow/#auto_advance">automatic collection</a> of the invoice. When <code>false</code>, the invoice's state will not automatically advance without an explicit action.
 ...
 * @property null|string|\Bkash\Charge $charge ID of the latest charge generated for this invoice, if any.
 * @property string $collection_method Either <code>charge_automatically</code>, or <code>send_invoice</code>. When charging automatically, Bkash will attempt to pay this invoice using the default source attached to the customer. When sending an invoice, Bkash will email this invoice to the customer with payment instructions.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://bkash.com/docs/currencies">supported currency</a>.
 * @property null|\Bkash\BkashObject[] $custom_fields Custom fields displayed on the invoice.
 * @property null|string|\Bkash\Customer $customer The ID of the customer who will be billed.
 * @property null|\Bkash\BkashObject $customer_address The customer's address. Until the invoice is finalized, this field will equal <code>customer.address</code>. Once the invoice is finalized, this field will no longer be updated.
 ...
 * @property null|\Bkash\BkashObject $customer_shipping The customer's shipping information. Until the invoice is finalized, this field will equal <code>customer.shipping</code>. Once the invoice is finalized, this field will no longer be updated.
 ...
 * @property null|\Bkash\BkashObject[] $customer_tax_ids The customer's tax IDs. Until the invoice is finalized, this field will contain the same tax IDs as <code>customer.tax_ids</code>. Once the invoice is finalized, this field will no longer be updated.
 * @property null|string|\Bkash\PaymentMethod $default_payment_method ID of the default payment method for the invoice. It must belong to the customer associated with the invoice. If not set, defaults to the subscription's default payment method, if any, or to the default payment method in the customer's invoice settings.
 * @property null|string|\Bkash\Account|\Bkash\BankAccount|\Bkash\Card|\Bkash\Source $default_source ID of the default payment source for the invoice. It must belong to the customer associated with the invoice and be in a chargeable state. If not set, defaults to the subscription's default source, if any, or to the customer's default source.
 * @property \Bkash\TaxRate[] $default_tax_rates The tax rates applied to this invoice, if any.
 ...
 * @property null|\Bkash\Discount $discount Describes the current discount applied to this invoice, if there is one. Not populated if there are multiple discounts.
 * @property null|(string|\Bkash\Discount)[] $discounts The discounts applied to the invoice. Line item discounts are applied before invoice discounts. Use <code>expand[]=discounts</code> to expand each discount.
 ...
 * @property null|\Bkash\BkashObject $from_invoice Details of the invoice that was cloned. See the <a href="https://bkash.com/docs/invoicing/invoice-revisions">revision documentation</a> for more details.
 ...
 * @property null|\Bkash\BkashObject $last_finalization_error The error encountered during the previous attempt to finalize the invoice. This field is cleared when the invoice is successfully finalized.
 * @property null|string|\Bkash\Invoice $latest_revision The ID of the most recent non-draft revision of this invoice
 * @property \Bkash\Collection<\Bkash\InvoiceLineItem> $lines The individual line items that make up the invoice. <code>lines</code> is sorted as follows: invoice items in reverse chronological order, followed by the subscription, if any.
 ...
 * @property null|string|\Bkash\Account $on_behalf_of The account (if any) for which the funds of the invoice payment are intended. If set, the invoice will be presented with the branding and support information of the specified account. See the <a href="https://bkash.com/docs/billing/invoices/connect">Invoices with Connect</a> documentation for details.
 ...
 * @property bool $paid_out_of_band Returns true if the invoice was manually marked paid, returns false if the invoice hasn't been paid yet or was paid on Bkash.
 * @property null|string|\Bkash\PaymentIntent $payment_intent The PaymentIntent associated with this invoice. The PaymentIntent is generated when the invoice is finalized, and can then be used to pay the invoice. Note that voiding an invoice will cancel the PaymentIntent.
 * @property \Bkash\BkashObject $payment_settings
 ...
 * @property null|string|\Bkash\Quote $quote The quote this invoice was generated from.
 * @property null|string $receipt_number This is the transaction number that appears on email receipts sent for this invoice.
 * @property null|\Bkash\BkashObject $rendering_options Options for invoice PDF rendering.
 ...
 * @property null|string $status The status of the invoice, one of <code>draft</code>, <code>open</code>, <code>paid</code>, <code>uncollectible</code>, or <code>void</code>. <a href="https://bkash.com/docs/billing/invoices/workflow#workflow-overview">Learn more</a>
 * @property \Bkash\BkashObject $status_transitions
 * @property null|string|\Bkash\Subscription $subscription The subscription that this invoice was prepared for, if any.
 ...
 * @property null|string|\Bkash\TestHelpers\TestClock $test_clock ID of the test clock this invoice belongs to.
 * @property \Bkash\BkashObject $threshold_reason
 * @property int $total Total after discounts and taxes.
 * @property null|\Bkash\BkashObject[] $total_discount_amounts The aggregate amounts calculated per discount across all line items.
 ...
 * @property \Bkash\BkashObject[] $total_tax_amounts The aggregate amounts calculated per tax rate for all line items.
 * @property null|\Bkash\BkashObject $transfer_data The account (if any) the payment will be attributed to for tax reporting, and where funds from the payment will be transferred to for the invoice.
 * @property null|int $webhooks_delivered_at Invoices are automatically paid or sent 1 hour after webhooks are delivered, or until all webhook delivery attempts have <a href="https://bkash.com/docs/billing/webhooks#understand">been exhausted</a>. This field tracks the time when webhooks for this invoice were successfully delivered. If the invoice had no webhooks to deliver, this will be set while the invoice is being created.
 */
class Invoice extends ApiResource
{
     ...
     *
     * @return \Bkash\Invoice the finalized invoice
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Invoice the uncollectible invoice
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Invoice the paid invoice
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Invoice the sent invoice
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Invoice the upcoming invoice
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\InvoiceLineItem> list of InvoiceLineItems
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Invoice the voided invoice
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\SearchResult<Invoice> the invoice search results
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\Collection<\Bkash\LineItem> the list of line items
     */
