 ...
 * href="https://bkash.com/docs/api#coupons">coupon</a>. It can be used to create
 ...
 * @property \Bkash\Coupon $coupon A coupon contains information about a percent-off or amount-off discount you might want to apply to a customer. Coupons may be applied to <a href="https://bkash.com/docs/api#subscriptions">subscriptions</a>, <a href="https://bkash.com/docs/api#invoices">invoices</a>, <a href="https://bkash.com/docs/api/checkout/sessions">checkout sessions</a>, <a href="https://bkash.com/docs/api#quotes">quotes</a>, and more. Coupons do not work with conventional one-off <a href="https://bkash.com/docs/api#create_charge">charges</a> or <a href="https://bkash.com/docs/api/payment_intents">payment intents</a>.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string|\Bkash\Customer $customer The customer that this promotion code can be used by.
 ...
 * @property \Bkash\BkashObject $restrictions
