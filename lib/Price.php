 ...
 * href="https://bkash.com/docs/api#products">Products</a> help you track
 ...
 *
 * Related guides: <a
 * href="https://bkash.com/docs/billing/subscriptions/set-up-subscription">Set up
 * a subscription</a>, <a
 * href="https://bkash.com/docs/billing/invoices/create">create an invoice</a>,
 * and more about <a
 * href="https://bkash.com/docs/products-prices/overview">products and prices</a>.
 *
 ...
 * @property \Bkash\BkashObject $currency_options Prices defined in each available currency option. Each key must be a three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a> and a <a href="https://bkash.com/docs/currencies">supported currency</a>.
 * @property null|\Bkash\BkashObject $custom_unit_amount When set, provides configuration for the amount to be adjusted by the customer during Checkout Sessions and Payment Links.
 ...
 * @property string|\Bkash\Product $product The ID of the product this price is associated with.
 * @property null|\Bkash\BkashObject $recurring The recurring components of a price such as <code>interval</code> and <code>usage_type</code>.
 ...
 * @property \Bkash\BkashObject[] $tiers Each element represents a pricing tier. This parameter requires <code>billing_scheme</code> to be set to <code>tiered</code>. See also the documentation for <code>billing_scheme</code>.
 ...
 * @property null|\Bkash\BkashObject $transform_quantity Apply a transformation to the reported usage or set quantity before computing the amount billed. Cannot be combined with <code>tiers</code>.
...
class Price extends ApiResource
{
     ...
     *
     * @return \Bkash\SearchResult<Price> the price search results
     */
