 ...
 *
 * Related guide: <a
 * href="https://bkash.com/docs/billing/subscriptions/subscription-schedules">Subscription
 * Schedules</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|string|\Bkash\BkashObject $application ID of the Connect Application that created the schedule.
 ...
 * @property null|\Bkash\BkashObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\Bkash\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \Bkash\BkashObject $default_settings
 ...
 * @property \Bkash\BkashObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property string $status The present status of the subscription schedule. Possible values are <code>not_started</code>, <code>active</code>, <code>completed</code>, <code>released</code>, and <code>canceled</code>. You can read more about the different states in our <a href="https://bkash.com/docs/billing/subscriptions/subscription-schedules">behavior guide</a>.
 * @property null|string|\Bkash\Subscription $subscription ID of the subscription managed by the subscription schedule.
 * @property null|string|\Bkash\TestHelpers\TestClock $test_clock ID of the test clock this subscription schedule belongs to.
 */
class SubscriptionSchedule extends ApiResource
{
     ...
     *
     * @return \Bkash\SubscriptionSchedule the canceled subscription schedule
     */
     ...
     * @throws \Bkash\Exception\ApiErrorException if the request fails
     *
     * @return \Bkash\SubscriptionSchedule the released subscription schedule
     */
