 ...
 * documentation.
 *
 * Related guide: <a href="https://bkash.com/docs/disputes">Disputes and
 * Fraud</a>.
 *
 ...
 * @property \Bkash\BalanceTransaction[] $balance_transactions List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your Bkash account as a result of this dispute.
 * @property string|\Bkash\Charge $charge ID of the charge that was disputed.
 ...
 * @property \Bkash\BkashObject $evidence_details
 * @property bool $is_charge_refundable If true, it is still possible to refund the disputed payment. Once the payment has been fully refunded, no further funds will be withdrawn from your Bkash account as a result of this dispute.
...
class Dispute extends ApiResource
{
     ...
     *
     * @return \Bkash\Dispute the closed dispute
     */
